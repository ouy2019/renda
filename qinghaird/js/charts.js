...
$(document).ready(function () {
   ...
   // localStorage.setItem()
                        ...
                        if (data[i].chartType == "bar") {
                           if(data[i].columns.filter){
                            ...
                            for(var k=0;k<columns.length; k++){
                                ...
                                if(Number(columns[k].columnOption.filterValues[0])){
        ...
        $.ajax({
            ...
            for (var j = 0; j < data.length - 1; j++) {
                ...
                if (data.length > 0) {
                    ...
                    $('.jqGrid_wrapper').append('<iframe src=" '+tableID+' " frameborder="0" scrolling="no" class="iframe"></iframe>')
                    ...
                    $('.mainExcel li').click(function () {
                        ...
                        localStorage.setItem('tableid', $(this).attr('id'))
                        id = $(this).attr('data-id')
    ...
    $('body').removeClass('is-loading')
    $('#orderfile').on('click', function () {
        window.location.href = './orderfile.html?id=' + id
    })
